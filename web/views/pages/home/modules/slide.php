        ...
        <ul class="slide-area">
            <li>
                ...
                <div class="slideOpt opt1">
                    ...
                    <div class="slideText" style="top:20%; left:10%; width:40%">
                        ...
                        <h3 class="text-uppercase" style="color: #888;">Lorem ipsum dolor flwaw</h3>
                        <a href="#">
            ...
            <li>
                ...
                <div class="slideOpt opt2">
                    <img src="<?php echo $path ?>views/assets/img/slide/2/iphone.png" style="top:15%; left:10%; width:45% ">
...
<div class="d-flex justify-content-center">
    <a class="btn border-0 rounded-0 templateColor py-2" id="btnSlide" style="width: 200px;">
