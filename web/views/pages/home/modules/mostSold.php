<div class="container-fluid bg-light border">
    <div class="container clearfix">
        <div class="btn-group float-end p-2">
            <button class="btn btn-default btnView " attr-type="grid" attr-index="3">
...
<div class="container-fluid bg-white">
    <div class="container">
        <div class="clearfix pt-3 pb-0 px-2">
            <h4 class="float-start text-uppercase pt-4">Articulos más vendidos</h4>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 pt-3 pb-4 grid-3">
            <div class="col px-3 py-2 py-lg-0">
                ...
                <h6><span class="badge badgeNew bg-warning text-uppercase text-white mt-1 p-2">Nuevo</span></h6>

                <div class="clearfix">
                    <h5 class="text-uppercase float-start text-muted">
                        <del class="small" style="color: #bbb;">USD $29</del>$11
                    </h5>
                    <span class="float-end">
                        <div class="btn-group btn-group-sm">
                            <button type="button" class="btn btn-right border">
        ...
        <div class="row list-3" style="display: none">
            <div class="media border-bottom  px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <div class="media-body ps-3">
                    ...
                    <p class="my-2 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quas!
                        Veniam tenetur qui vel iusto soluta perferendis ad fugiat eum.
                        Corporis, voluptate sunt! Sint tenetur fuga, ullam deleniti blanditiis quibusdam.
                        Id veritatis porro in dolorum, dignissimos quisquam fugiat laudantium qui?
                        Error dignissimos fugit doloremque placeat natus facilis sed, veritatis deleniti?
                    </p>

                    <div class="clearfix">
                        <h5 class="text-uppercase float-start text-muted"><small>Gratis</small></h5>
                        <span class="float-end">
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-right border">
                                    <i class="fas fa-heart"></i>
            ...
            <div class="media border-bottom  px-3 pt-4 pb-3 pb-lg-2 ">
                ...
                <div class="media-body ps-3">
                    <h5><small class="text-uppercase text-muted">bolso gris</small></h5>
                    <span class="badge badgeNew bg-warning text-uppercase text-white p-2">Nuevo</span>
                    <p class="my-2 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quas!
                        Veniam tenetur qui vel iusto soluta perferendis ad fugiat eum.
                        Corporis, voluptate sunt! Sint tenetur fuga, ullam deleniti blanditiis quibusdam.
